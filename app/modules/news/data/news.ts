...
export const news: DemoNews[] = [
  {
    ...
    content: {
      children: [
        "<h1>La Copa Matchday entra en su etapa decisiva</h1>",
        "Cada encuentro empieza a dibujar el camino hacia la final y ya no queda espacio para regalar puntos.",
        "<h2>Historias que se cruzan en cada jornada</h2>",
        ...
        "<h3>Todo lo que pasa en la cancha</h3>",
  ...
  },
  {
    ...
    content: {
      children: [
        "<h1>Atlético Santiago prepara su próximo encuentro</h1>",
        ...
        "<h2>Una semana de trabajo intenso</h2>",
  ...
  },
  {
    ...
    content: {
      children: [
        "<h1>El plantel ya trabaja con todos sus integrantes</h1>",
        ...
        "<h2>Preparación física y táctica</h2>",
